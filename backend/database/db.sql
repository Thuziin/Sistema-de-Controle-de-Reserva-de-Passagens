...
CREATE TABLE AERONAVE 
    ( 
     Inscricao  VARCHAR2 (6)  NOT NULL , 
     Modelo     VARCHAR2 (10)  NOT NULL , 
     N_Assentos NUMBER (3)  NOT NULL 
    ) 
;
...
CREATE TABLE AEROPORTO 
    ( 
     Identificador VARCHAR2 (3)  NOT NULL , 
...
CREATE TABLE PASSAGEM 
    ( 
     Data                    DATE  NOT NULL , 
     Hora                    DATE  NOT NULL , 
     VOO_ID                  NUMBER (2)  NOT NULL , 
     PESSOA_CPF_COMPRA       VARCHAR2 (11)  NOT NULL , 
     AEROPORTO_Identificador VARCHAR2 (3)  NOT NULL , 
     REGISTRO_PESSOA_CPF     VARCHAR2 (11)  NOT NULL , 
     Valor                   NUMBER  NOT NULL , 
     Assento                 VARCHAR2 (4)  NOT NULL 
    ) 
;
...
CREATE TABLE PESSOA 
    ( 
     ...
     P_Nome          VARCHAR2 (15)  NOT NULL , 
     U_Nome          VARCHAR2 (15)  NOT NULL , 
...
CREATE TABLE REGISTRO 
    ( 
     P_Nome     VARCHAR2 (15)  NOT NULL , 
     U_Nome     VARCHAR2 (15)  NOT NULL , 
     PESSOA_CPF VARCHAR2 (11)  NOT NULL 
    ) 
;
...
CREATE TABLE VOO 
    ( 
     ...
     AERONAVE_Inscricao   VARCHAR2 (6)  NOT NULL , 
     AEROPORTO_ID_CHEGADA VARCHAR2 (3)  NOT NULL , 
     AEROPORTO_ID_PARTIDA VARCHAR2 (3)  NOT NULL 
    ) 
;
